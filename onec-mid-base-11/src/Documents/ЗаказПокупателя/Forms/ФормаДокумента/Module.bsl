...
&НаКлиенте
Процедура Net_ПересчитатьТаблицуПосле(Команда)
...
Процедура Net_ РассчитатьСуммуСтроки(ТекущиеДанные)
...
&НаКлиенте
Асинх Процедура Net_СогласованнаяСкидкаПриИзмененииПосле(Элемент)
